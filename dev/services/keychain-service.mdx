...
<Warning>
**NOT Using macOS Keychain**

Despite its name, this service **does not** use the macOS Keychain. Credentials are stored in **plain text** in UserDefaults without encryption. This is a deliberate design choice for a personal single-user tool, prioritizing simplicity over maximum security.
